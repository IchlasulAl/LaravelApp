        ...
        <div class="col-6">
            ...
            <form method="post" action="/students">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('nrp') is-invalid @enderror" id="nrp" placeholder="Masukan nrp" name="nrp">@error('nama')<div class="invalid-feedback">{{$message}}</div>
                    @enderror
                </div>
                <div class="form-group">
